<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Home.Master" CodeBehind="ImmedaiteSupervisor.aspx.cs" Inherits="MyOwnWebsite.Forms.ImmedaiteSupervisor" %>
            ...
            <div align="center">
                <table>
                    <tr>
                        ...
                        <td style="font-family: 'Bookman Old Style', Times, serif; font-size: large; font-weight: 200">
                            <asp:DropDownList ID="ddlempno" runat="server" AutoPostBack="true" EnableViewState="true" Width="120%" class="form-control input-sm" OnSelectedIndexChanged="ddlempno_SelectedIndexChanged"></asp:DropDownList>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div class="panel panel-primary" id="divhide" runat="server">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-4 col-sm-12" id="divselectprocess" runat="server">
                ...
                <asp:DropDownList ID="drpselectionprjct" class="form-control input-sm" runat="server" Font-Bold="true" AutoPostBack="true" OnSelectedIndexChanged="drpselectionprjct_SelectedIndexChanged">
            ...
            <div class="form-group col-md-4 col-sm-12" id="divprjct" runat="server">
                ...
                <asp:DropDownList ID="drpexistingprjct" class="form-control input-sm" runat="server" Font-Bold="true" AutoPostBack="true" OnSelectedIndexChanged="drpexistingprjct_SelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group col-md-4 col-sm-12" id="divnewprjct" runat="server">
                <label for="New Project">New Project </label>
                <asp:DropDownList ID="drpnewprjct" class="form-control input-sm" runat="server" Font-Bold="true" AutoPostBack="true" OnSelectedIndexChanged="drpnewprjct_SelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group col-md-4 col-sm-12" id="divdept" runat="server">
                <label for="existingdept">Existing Department</label>
                <asp:DropDownList ID="drpexisitngdept" class="form-control input-sm" runat="server" Font-Bold="true" AutoPostBack="true" OnSelectedIndexChanged="drpexisitngdept_SelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group col-md-4 col-sm-12" id="divnewdept" runat="server">
                <label for="newdept">New Department</label>
                <asp:DropDownList ID="drpnewdept" class="form-control input-sm" runat="server" Font-Bold="true" AutoPostBack="true" OnSelectedIndexChanged="drpnewdept_SelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group col-md-4 col-sm-12" id="divfunction" runat="server">
                <label for="existingfunction">Existing Function</label>
                <asp:DropDownList ID="drpexistingfunction" class="form-control input-sm" runat="server" AutoPostBack="true" Font-Bold="true" OnSelectedIndexChanged="drpexistingfunction_SelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group col-md-4 col-sm-12" id="divexisfunction" runat="server">
                <label for="newfunction">New Function</label>
                <asp:DropDownList ID="drpnewfunction" class="form-control input-sm" runat="server" Font-Bold="true" AutoPostBack="true" OnSelectedIndexChanged="drpnewfunction_SelectedIndexChanged"></asp:DropDownList>
            </div>
        </div>
    </div>
    <div class="panel">
        <div class="col-md-5 col-sm-3">
            <div class="form-group col-md-2 col-sm-2 pull-right">
                <table>
                    <tr>
                        <td>
                            <asp:Button ID="btnapprove" runat="server" class="btn btn-danger" OnClientClick="Populate();" value="Submit" Text="Approve" OnClick=" btnapprove_Click" />
                        </td>
                        <td>&nbsp;
                            <td>
